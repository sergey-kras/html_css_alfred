...
$( document ).ready( function() {
    var entries = [ 
            { image: './img/foto-1.png', width: '384', height: '277'},
            { image: './img/foto-2.png',  width: '384', height: '277'},
            { image: './img/foto-3.png',  width: '384', height: '277'},
            { image: './img/foto-4.png',  width: '384', height: '277' },
            { image: './img/foto-5.png', width: '384', height: '277'},
    ];
    var settings = {
        entries: entries,
        width: 1110,
